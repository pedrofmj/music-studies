...
| Airstar target-specific SMC-MIX relay topology trial | 🟡 Eight fader-specific relay outputs were verified and relay processing had 0 adapter failures, but the synchronized single-fader/audio probe reproduced 300 PipeWire ERR counts (speaker sink +171, SMC-MIX EQ +129); topology rejected; [evidence](../../tools/music-rig/benchmarks/smc-mixer-relay-target-specific-routing-failure-airstar-2026-08-31.json) |
| Airstar coalesced SMC-MIX relay three-cycle tuning trial | 🟡 A nominal 64 ms latest-value flush delay produced 302 PipeWire ERR counts (speaker sink +157, SMC-MIX EQ +145) with relay result 0 and 0 adapter failures; tuning rejected and one-cycle behavior restored; [evidence](../../tools/music-rig/benchmarks/smc-mixer-relay-three-cycle-tuning-failure-airstar-2026-09-01.json) |
...
| Airstar coalesced SMC-MIX relay duplicate suppression trial | 🟡 No duplicate values were observed to suppress; the 120-second single-fader/audio probe added 144 PipeWire ERR counts (speaker sink +76, SMC-MIX EQ +68), with relay result 0 and 0 adapter failures; tuning rejected; [evidence](../../tools/music-rig/benchmarks/smc-mixer-relay-duplicate-suppression-failure-airstar-2026-08-31.json) |
...
- 🟡 Meet switch latency, resource, and xrun thresholds. The offline runtime
  ...
  synchronized SMC-MIX-plus-audio probe. That synchronized probe reproduced
